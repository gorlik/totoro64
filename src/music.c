...
#define CMD_REG    0xe0
#define CMD_OFFSET 0xfd
#define CMD_INSTR  0xfe
#define CMD_END    0xff


#define WR_REG(a) (CMD_REG|a)
#define INSTR(a)  (a*sizeof(struct instr_t))
...
const struct instr_t itable[] = {
  { 0x10, 0x80, 0xf6, },  // instrument 0
  { 0x10, 0x80, 0x86, },
};

const uint8_t track0_data[] = {
  CMD_INSTR, INSTR(0),     // set instrument
  CMD_OFFSET, 0x16, 
  ...
  0x04,0x00, // small pause before restart
  CMD_END, CMD_END, 
};


const uint8_t track1_data[] = {
  CMD_INSTR, INSTR(1),     // set instrument
  CMD_OFFSET, 0x16,   // set offset
